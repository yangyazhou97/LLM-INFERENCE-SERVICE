...
def _get_logits(hidden_states: torch.Tensor, embedding: torch.Tensor,
    ...
    print("logits:",logits.shape,"hidden_states:",hidden_states.shape,"embedding.t():",embedding.t().shape)
...
def _prune_hidden_states(
    ...
    print("input_metadata.prompt_lens:",input_metadata.prompt_lens)
    for prompt_len in input_metadata.prompt_lens:
        last_token_indicies.append(start_idx + prompt_len - 1)
        start_idx += prompt_len
    print("last_token_indicies:",last_token_indicies)
    print("input_metadata.num_generation_tokens:",input_metadata.num_generation_tokens)
...
#     start_idx = 0
#     print("input_metadata.seq_groups:",input_metadata.seq_groups)
...
#             print("else:last_token_indices:",last_token_indices)
#             start_idx += num_seqs
...
def _get_output_tokens(input_metadata: InputMetadata) -> List[List[int]]:
    ...
    print("input_metadata.num_prompts:",input_metadata.num_prompts)
    for seq_group in input_metadata.seq_groups:
        seq_ids, _ = seq_group
