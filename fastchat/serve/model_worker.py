...
class ModelWorker(BaseModelWorker):
    ...
    def generate_stream_gate(self, params):
        ...
        # print("tokenizer.bos_token_id :", self.tokenizer.bos_token_id )
        # print("tokenizer.pad_token_id :", self.tokenizer.pad_token_id )
        # print("tokenizer.eos_token_id :", self.model.config.eos_token_id )
        # print("tokenizer.bos_token_id :", self.model.config.bos_token_id )
        # print("tokenizer.pad_token_id :", self.model.config.pad_token_id )
        try:
